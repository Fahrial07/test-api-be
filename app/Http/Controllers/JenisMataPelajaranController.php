...
class JenisMataPelajaranController extends Controller
{
    ...
    {
        try {
            $get = JenisMataPelajaran::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
      try {
            ...
            $store = JenisMataPelajaran::create($data);
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $update = JenisMataPelajaran::where('id', $id)->update($data);
    ...
    public function destroy($id)
    {
        try {
            ...
            $delete = JenisMataPelajaran::destroy($id);
